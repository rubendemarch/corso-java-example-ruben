...
<table><tr><td colspan="2">
	...
	<input	type="url" value="" name="url" maxlength="150" size="50" onblur="cleanUrl(this)">
	</td></tr><tr><td>
	...
	<input	type="url" value="" name="logoUrl" id="logoUrl" maxlength="150" size="50" onblur="cleanUrl(this)">
	</td><td>
